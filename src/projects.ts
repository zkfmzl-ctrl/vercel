...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'MOTION',
    year: '05',
    media: '/videos/pet/banryeodongmul-festival.mp4',
    mediaType: 'video',
    poster: '/images/pet/chuncheon/poster.png',
    mediaAspect: '9:16',
    duration: '00:46',
    description: '반려동물 페스티벌을 위해 제작한 46초 세로형 AI 리얼리티 영상입니다.',
    tech: ['MOTION', 'EDITING'],
    ...
    caseStudy: {
      copy: {
        ...
        final: '춘천의 풍경과 보호자·강아지의 신뢰 회복 서사를 46초 세로 영상과 키이미지로 확장했습니다.',
